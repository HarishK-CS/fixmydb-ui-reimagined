...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | FixMyDB</title>
        <meta name="description" content="Contact FixMyDB for expert database consulting, 24/7 support, and a free consultation. Reach out to our team for all your database needs." />
        <meta name="keywords" content="Contact FixMyDB, database consulting, database support, free consultation, database experts" />
        <link rel="canonical" href="https://fixmydb.com/contact" />
        <meta property="og:title" content="Contact Us | FixMyDB – Database Consulting & Support" />
        <meta property="og:description" content="Get in touch with FixMyDB for database consulting, support, and a free assessment. We're here to help you optimize your data infrastructure." />
        <meta property="og:url" content="https://fixmydb.com/contact" />
